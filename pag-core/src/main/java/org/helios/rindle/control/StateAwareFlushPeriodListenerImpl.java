 ...
 * <p><code>org.helios.rindle.control.StateAwareFlushPeriodListenerImpl</code></p>
 */
...
public class StateAwareFlushPeriodListenerImpl extends FlushPeriodListenerImpl implements IStateAwareFlushPeriodListener {
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.rindle.control.IStateAwareFlushPeriodListener#onPeriodActivate(int)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.rindle.control.IStateAwareFlushPeriodListener#onPeriodDeactivate(int)
	 */
	@Override
