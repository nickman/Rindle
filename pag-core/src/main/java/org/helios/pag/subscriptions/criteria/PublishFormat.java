 ...
 *
 */
package org.helios.pag.subscriptions.criteria;
 ...
 * <p><code>org.helios.pag.subscriptions.criteria.PublishFormat</code></p>
 */
...
public enum PublishFormat implements PickOne<PublishFormat>{
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.subscriptions.criteria.PickOne#getDefault()
	 */
	@Override
