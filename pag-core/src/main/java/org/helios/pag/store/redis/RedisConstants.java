 ...
 * <p><code>org.helios.pag.store.redis.RedisConstants</code></p>
 */
...
public class RedisConstants {
	...
	public static final String REDIS_AUTH_CONF = "helios.pag.redis.auth";
	...
	public static final String REDIS_DB_CONF = "helios.pag.redis.database";
	...
	public static final String REDIS_MAX_TOTAL_CONF = "helios.pag.redis.maxtotal";
	...
	public static final String REDIS_TEST_WHILE_IDLE_CONF = "helios.pag.redis.testwhileidle";
	...
	public static final String REDIS_TIME_BETWEEN_EVICTION_RUNS_CONF = "helios.pag.redis.timebetweenevictionruns";
	...
	public static final String REDIS_EVICTION_POLICY_CLASS_NAME_CONF = "helios.pag.redis.evictionpolicyclassname";
	...
	public static final String REDIS_BLOCK_WHEN_EXHAUSTED_CONF = "helios.pag.redis.blockwhenexhausted";
	...
	public static final String REDIS_JMX_ENABLED_CONF = "helios.pag.redis.jmxenabled";
	...
	public static final String REDIS_JMX_NAME_PREFIX_CONF = "helios.pag.redis.jmxnameprefix";
	...
	public static final String REDIS_LIFO_CONF = "helios.pag.redis.lifo";
	...
	public static final String REDIS_MAX_WAIT_CONF = "helios.pag.redis.maxwait";
	/** The default configuration for the Redis connection pool maximum wait time in ms. */
	public static final long DEFAULT_REDIS_MAX_WAIT = 1000;

	/** The configuration property name for the Redis connection pool minimum idle connection eviction time in ms. */
	public static final String REDIS_MIN_EVICTABLE_IDLE_TIME_CONF = "helios.pag.redis.minevictableidletime";
	...
	public static final String REDIS_SOFT_MIN_EVICTABLE_IDLE_TIME_CONF = "helios.pag.redis.softminevictableidletime";
	...
	public static final String REDIS_NUM_TESTS_PER_EVICTION_RUN_CONF = "helios.pag.redis.numtestsperevictionrun";
	...
	public static final String REDIS_TEST_ON_BORROW_CONF = "helios.pag.redis.testonborrow";
	...
	public static final String REDIS_TEST_ON_RETURN_CONF = "helios.pag.redis.testonreturn";
