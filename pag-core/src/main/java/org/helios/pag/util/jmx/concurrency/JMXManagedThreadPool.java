 ...
 *
 */
package org.helios.pag.util.jmx.concurrency;
 ...
 * <p><code>org.helios.pag.util.jmx.concurrency.JMXManagedThreadPool</code></p>
 */
...
public class JMXManagedThreadPool extends ThreadPoolExecutor implements ThreadFactory, RejectedExecutionHandler, UncaughtExceptionHandler, JMXManagedThreadPoolMBean {
	 ...
	 */
	public JMXManagedThreadPool(String poolName) {
		this(JMXHelper.objectName(ConfigurationHelper.getSystemThenEnvProperty(JMX_DOMAIN_PREFIX, DEFAULT_JMX_DOMAIN_PREFIX) + ".core:service=Threadpool,pool=" + poolName), poolName);
	}
	...
	public JMXManagedThreadPool(ObjectName objectName, String poolName, int corePoolSize, int maximumPoolSize, int queueSize, long keepAliveTimeMs, int metricWindowSize, int metricDefaultPercentile) {
		...
		log = LogManager.getLogger(getClass().getName() + "." + poolName);
	...
	public void uncaughtException(Thread t, Throwable e) {
		...
		log.error("Thread pool handled uncaught exception on thread [" + t + "]", e);
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getObjectName()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getPoolName()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getQueueDepth()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getQueueCapacity()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getUncaughtExceptionCount()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getRejectedExecutionCount()
	 */
	@Override
...
//	/**
//	 * {@inheritDoc}
//	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getMetrics()
//	 */
//	@Override
...
//	/**
//	 * {@inheritDoc}
//	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getMetricsTable()
//	 */
//	@Override
...
//	}
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getExecutingTaskCount()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#getKeepAliveTime()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#setKeepAliveTime(long)
	 */
	@Override
...
//	/**
//	 * {@inheritDoc}
//	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#reset()
//	 */
//	@Override
//	public void reset() {
//		t
//	}
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.jmx.concurrency.JMXManagedThreadPoolMBean#waitForCompletion(java.util.Collection, long)
	 */
	@Override
