...
package org.helios.pag.util.unsafe.collections;
 ...
 * <p><code>org.helios.pag.util.collections.ConcurrentLongSlidingWindow</code></p>
 */
...
public class ConcurrentLongSlidingWindow extends LongSlidingWindow implements ILongSlidingWindow {
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#insert(long)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#insert(java.nio.LongBuffer)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#inc(int, long)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#inc(int)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#inc(long)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#inc()
	 */
	@Override
	public long inc() {
		return inc(0, 1L);
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#find(long)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#set(long)
	 */
	@Override
    ...
    /**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#asDoubleArray()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#load(byte[])
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#reinitAndLoad(byte[])
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#clear()
	 */
	@Override
	public void clear() {
		writeLock.lock();
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#isEmpty()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#toString()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#clone()
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#get(int)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#size()
	 */
	@Override
	public int size() {
		readLock.lock();
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.unsafe.collections.LongSlidingWindow#min()
	 */
	@Override
	public long min() {
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.unsafe.collections.ILongSlidingWindow#max()
	 */
	@Override
	public long max() {
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#sum(int)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#sum()
	 */
	@Override
	public long sum() {
		readLock.lock();
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#avg(int)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see org.helios.pag.util.collections.ILongSlidingWindow#avg()
	 */
	@Override
	public long avg() {
		readLock.lock();
