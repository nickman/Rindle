 ...
 * <p><code>org.helios.pag.util.unsafe.UnsafeAdapter</code></p>
 */
...
//   	public Set<String> getNonDeallocatingAllocators();
    ...
    public static class UnsafeMemory implements UnsafeMemoryMBean  {
		...
		/**
		 * {@inheritDoc}
		 * @see org.helios.pag.util.unsafe.UnsafeAdapter.UnsafeMemoryMBean#getTotalAllocatedMemory()
		 */
		@Override
		public long getTotalAllocatedMemory() {
		...
		/**
		 * {@inheritDoc}
		 * @see org.helios.pag.util.unsafe.UnsafeAdapter.UnsafeMemoryMBean#getTotalAllocationCount()
		 */
		@Override
		public int getTotalAllocationCount() {
		...
		/**
		 * {@inheritDoc}
		 * @see org.helios.pag.util.unsafe.UnsafeAdapter.UnsafeMemoryMBean#getTotalAllocatedMemoryKb()
		 */
		@Override
		public long getTotalAllocatedMemoryKb() {
			if(!trackMem) return -1L;
		...
		/**
		 * {@inheritDoc}
		 * @see org.helios.pag.util.unsafe.UnsafeAdapter.UnsafeMemoryMBean#getTotalAllocatedMemoryMb()
		 */
		@Override
		public long getTotalAllocatedMemoryMb() {
			if(!trackMem) return -1L;
